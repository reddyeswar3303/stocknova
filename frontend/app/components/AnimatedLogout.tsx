...
const logoutButtonStates: Record<string, any> = {
  'default': {
    '--figure-duration': '100',
...
export default function AnimatedLogout({ onLogout }: { onLogout: () => void }) {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                // Reset (though the page will likely redirect)
                setIsClicked(false);
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <button 
        ...
        onMouseEnter={() => buttonState === 'default' && updateState('hover')}
        onMouseLeave={() => buttonState === 'hover' && updateState('default')}
        onClick={handleClick}
      >
        ...
        <svg className="door" viewBox="0 0 100 100" style={{ fill: '#EB5B3C' }}>
          <path d="M93.4 86.3H58.6c-1.9 0-3.4-1.5-3.4-3.4V17.1c0-1.9 1.5-3.4 3.4-3.4h34.8c1.9 0 3.4 1.5 3.4 3.4v65.8c0 1.9-1.5 3.4-3.4 3.4z" />
